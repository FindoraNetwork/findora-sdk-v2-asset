import {
  getLedger,
  FindoraWalletTypes as FindoraWallet,
  bigNumber,
...
import { Keypair as KeypairApi, WalletKeypar } from '@findora-network/findora-sdk-v2-keypair';
// import * as Network from '../network';
import { Network, NetworkEnvironment } from '@findora-network/findora-sdk-v2-network';
// import { toWei } from '../../services/bigNumber';
import { builder as Builder } from '@findora-network/findora-sdk-v2-utxo';
 ...
 */
export const getFraAssetCode = feeService.getFraAssetCode;
...
export const getMinimalFee = feeService.getMinimalFee;
...
export const getBarToAbarMinimalFee = feeService.getBarToAbarMinimalFee;
...
export const getFraPublicKey = feeService.getFraPublicKey;
...
export const getIssueAssetTransactionBuilder = async (
  ...
  const utxoNumbers = BigInt(bigNumber.toWei(amountToIssue, assetDecimals).toString());
...
export const defineAsset = async (
  ...
  const transferOperationBuilder = await Builder.buildTransferOperationWithFee(walletInfo);
