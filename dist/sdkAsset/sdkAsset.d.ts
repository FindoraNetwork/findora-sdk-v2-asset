import { FindoraWalletTypes as FindoraWallet, AssetRules as LedgerAssetRules, TransactionBuilder, XfrKeyPair } from '@findora-network/findora-sdk-v2-core';
...
export declare const getFraPublicKey: () => Promise<import("findora-wallet-wasm/nodejs").XfrPublicKey>;
