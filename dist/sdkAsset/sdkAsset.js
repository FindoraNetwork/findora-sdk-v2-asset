...
exports.issueAsset = exports.defineAsset = exports.getIssueAssetTransactionBuilder = exports.getDefineAssetTransactionBuilder = exports.getAssetDetails = exports.getAssetRules = exports.getDefaultAssetRules = exports.getAssetCodeToSend = exports.getDerivedAssetCode = exports.getRandomAssetCode = exports.getAssetCode = exports.getFraPublicKey = exports.getBarToAbarMinimalFee = exports.getMinimalFee = exports.getFraAssetCode = void 0;
...
var findora_sdk_v2_utxo_1 = require("@findora-network/findora-sdk-v2-utxo");
 ...
 */
exports.getFraAssetCode = findora_sdk_v2_core_1.feeService.getFraAssetCode;
// export const getFraAssetCode = async (): Promise<string> => {
//   const ledger = await getLedger();
//   const assetCode = ledger.fra_get_asset_code();
//   return assetCode;
// };
exports.getMinimalFee = findora_sdk_v2_core_1.feeService.getMinimalFee;
// export const getMinimalFee = async (): Promise<BigInt> => {
//   const ledger = await getLedger();
//   const fee = ledger.fra_get_minimal_fee();
//   return fee;
// };
exports.getBarToAbarMinimalFee = findora_sdk_v2_core_1.feeService.getBarToAbarMinimalFee;
// export const getBarToAbarMinimalFee = async (): Promise<BigInt> => {
//   const ledger = await getLedger();
//   const fee = ledger.fra_get_minimal_fee_for_bar_to_abar();
//   return fee;
// };
exports.getFraPublicKey = findora_sdk_v2_core_1.feeService.getFraPublicKey;
...
var getAssetRules = function (newAssetRules) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2: return [4 /*yield*/, (0, findora_sdk_v2_core_1.getLedger)()];
            case 3:
                ledger = _a.sent();
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, findora_sdk_v2_utxo_1.builder.getTransactionBuilder()];
                case 1:
...
var getIssueAssetTransactionBuilder = function (walletKeypair, assetName, amountToIssue, assetBlindRules, assetDecimals) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, findora_sdk_v2_utxo_1.builder.getBlockHeight()];
            case 1:
                blockCount = _a.sent();
                utxoNumbers = BigInt(findora_sdk_v2_core_1.bigNumber.toWei(amountToIssue, assetDecimals).toString());
...
var defineAsset = function (walletInfo, assetName, assetMemo, newAssetRules) { return __awaiter(void 0, void 0, void 0, function () {
    var assetRules, transferOperationBuilder, receivedTransferOperation, e, transactionBuilder, err_2, e, e;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, exports.getAssetRules)(newAssetRules)];
            case 1:
                assetRules = _a.sent();
                return [4 /*yield*/, findora_sdk_v2_utxo_1.builder.buildTransferOperationWithFee(walletInfo)];
            case 2:
...
var issueAsset = function (walletInfo, assetName, amountToIssue, assetBlindRules, assetDecimals) { return __awaiter(void 0, void 0, void 0, function () {
    var asset, decimals, transferOperationBuilder, receivedTransferOperation, e, transactionBuilder, err_3, e, e;
    return __generator(this, function (_a) {
        switch (_a.label) {
